...
def _load_oute_tts(model_id: str, **kwargs) -> TTSModel:
    ...
    return TTSModel(model, model_id, model.audio_codec.sr)


def _load_bark_tts(model_id: str) -> TTSModel:
    """
    ...
    return TTSModel(
        ...
        model_id=model_id,
        sample_rate=24_000,
        cusotm_args={"bark_processor": processor},
    )
...
TTS_LOADERS = {
    ...
    "parler-tts/parler-tts-mini-multilingual-v1.1": _load_parler_tts,
    "ai4bharat/indic-parler-tts": _load_parler_tts,
}
