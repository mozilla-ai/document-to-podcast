...
from document_to_podcast.preprocessing.data_loaders import load_pdf, load_txt, load_file
...
def test_load_and_clean_html(example_data):
    text = markdown_to_text(load_file(str(example_data / "introducing-mozilla-ai-investing-in-trustworthy-ai.html")))
